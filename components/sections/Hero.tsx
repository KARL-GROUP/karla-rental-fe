...
const Hero = () => {
    return (
        // <SectionWrapper>
        <section className="pt-44 lg:pl-24 flex flex-col lg:flex-row justify-between">
            <div className="lg:w-1/2 px-10 flex flex-col gap-5">
            ...
            <div className=" flex justify-end h-[40vh] lg:h-auto relative lg:w-2/5 mt-10 lg:mt-0">
